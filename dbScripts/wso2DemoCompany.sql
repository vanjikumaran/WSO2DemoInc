...
ALTER TABLE Files ADD CONSTRAINT files_pk PRIMARY KEY( fileName );
...
ALTER TABLE FileRecords ADD FOREIGN KEY(fileName) REFERENCES Files(fileName) ON UPDATE CASCADE ON DELETE CASCADE ;
...
insert into Customers values (144,'Volvo Model Replicas, Co','Berglund','Christina ','0921-12 3555','Berguvsvgen  8',NULL,'Lule',NULL,'S-958 22','Sweden',1504,53100.0);
insert into Customers values (145,'Danish Wholesale Imports','Petersen','Jytte ','31 12 3555','Vinbltet 34',NULL,'Kobenhavn',NULL,'1734','Denmark',1401,83400.0);
...
insert into Customers values (169,'Porto Imports Co.','de Castro','Isabel ','(1) 356-5555','Estrada da sade n. 58',NULL,'Lisboa',NULL,'1756','Portugal',NULL,0.0);
insert into Customers values (171,'Daedalus Designs Imports','Ranc','Martine ','20.16.1555','184, chausse de Tournai',NULL,'Lille',NULL,'59000','France',1370,82900.0);
...
insert into Customers values (209,'Mini Caravy','Citeaux','Frdrique ','88.60.1555','24, place Klber',NULL,'Strasbourg',NULL,'67000','France',1370,53800.0);
...
insert into Customers values (216,'Enaco Distributors','Saavedra','Eduardo ','(93) 203 4555','Rambla de Catalua, 23',NULL,'Barcelona',NULL,'08022','Spain',1702,60300.0);
...
insert into Customers values (223,'Natrlich Autos','Kloss','Horst ','0372-555188','Taucherstrae 10',NULL,'Cunewalde',NULL,'01307','Germany',NULL,0.0);
...
insert into Customers values (233,'Qubec Home Shopping Network','Fresnire','Jean ','(514) 555-8054','43 rue St. Laurent',NULL,'Montral','Qubec','H1J 1C3','Canada',1286,48700.0);
insert into Customers values (237,'ANG Resellers','Camino','Alejandra ','(91) 745 6555','Gran Va, 1',NULL,'Madrid',NULL,'28001','Spain',NULL,0.0);
...
insert into Customers values (256,'Auto Associs & Cie.','Tonini','Daniel ','30.59.8555','67, avenue de l''Europe',NULL,'Versailles',NULL,'78000','France',1370,77900.0);
insert into Customers values (259,'Toms Spezialitten, Ltd','Pfalzheim','Henriette ','0221-5554327','Mehrheimerstr. 369',NULL,'Kln',NULL,'50739','Germany',1504,120400.0);
...
insert into Customers values (273,'Franken Gifts, Co','Franken','Peter ','089-0877555','Berliner Platz 43',NULL,'Mnchen',NULL,'80805','Germany',NULL,0.0);
...
insert into Customers values (298,'Vida Sport, Ltd','Holz','Mihael','0897-034555','Grenzacherweg 237',NULL,'Genve',NULL,'1203','Switzerland',1702,141300.0);
...
insert into Customers values (335,'Cramer Spezialitten, Ltd','Cramer','Philip ','0555-09555','Maubelstr. 90',NULL,'Brandenburg',NULL,'14776','Germany',NULL,0.0);
...
insert into Customers values (361,'Kommission Auto','Josephs','Karin','0251-555259','Luisenstr. 48',NULL,'Mnster',NULL,'44087','Germany',NULL,0.0);
...
insert into Customers values (409,'Stuttgart Collectable Exchange','Mller','Rita ','0711-555361','Adenauerallee 900',NULL,'Stuttgart',NULL,'70563','Germany',NULL,0.0);
...
insert into Customers values (448,'Scandinavian Gift Ideas','Larsson','Martha','0695-34 6555','kergatan 24',NULL,'Brcke',NULL,'S-844 67','Sweden',1504,116400.0);
...
insert into Customers values (458,'Corrida Auto Replicas, Ltd','Sommer','Martn ','(91) 555 22 82','C/ Araquil, 67',NULL,'Madrid',NULL,'28023','Spain',1702,104600.0);
...
insert into Customers values (477,'Mit Vergngen & Co.','Moos','Hanna ','0621-08555','Forsterstr. 57',NULL,'Mannheim',NULL,'68306','Germany',NULL,0.0);
...
insert into Products values ('S32_1268','1980s GM Manhattan Express','Trucks and Buses','1:32','Motor City Art Classics','This 1980s era new look Manhattan express is still active, running from the Bronx to mid-town Manhattan. Has 35 opeining windows and working lights. Needs a battery.',5099,53.93,96.31);
